...
周永涛，博士，副教授，中国仿真算法专业委员会委员。主要从事分数阶微分方程数值解、分数阶微分方程快速迭代算法、带弱奇异核的Volterra积分-微分方程数值解及无网格数值解法的研究。
...
1. 2025-2026-春季
   ...
   线性代数（40学时）；毕业实习（数学与应用数学22级）；毕业论文（数学与应用数学22级）

1. 2025-2026-秋季

   数值分析（数学与应用数学23级，64学时）；数值分析（信息与计算科学23级，56学时）；数值分析（研究生课程，48学时）；计算方法（40学时）；课程设计（数学与应用数学23级，32学时）；专业技能实践（数学与应用数学22级，32学时）

1. 2024-2025-春季

   线性代数（40学时）；毕业实习（数学与应用数学21级）；毕业论文（数学与应用数学21级）

1. 2024-2025-秋季

   数值分析（数学与应用数学22级，64学时）；数值分析（信息与计算科学22级，56学时）；数值分析（工程力学22级，32学时）；专业技能实践（数学与应用数学21级，32学时）
...
1. 2025年6月
   ...
   青岛理工大学本科优秀毕业设计（论文）“校级一等奖”指导教师（学生：蔡隆博）

1. 2025年5月

   第十六届蓝桥杯全国软件和信息技术专业人才大赛山东赛区Web应用开发大学组“三等奖”优秀指导教师（学生：袁竟程）

1. 2025年5月

   第十六届蓝桥杯全国软件和信息技术专业人才大赛山东赛区Python程序设计大学B组“三等奖”优秀指导教师（学生：李洁）

1. 2025年5月

   第十六届蓝桥杯全国软件和信息技术专业人才大赛山东赛区Java软件开发大学B组“三等奖”优秀指导教师（学生：杨连豪）
...
1. 青岛理工大学一流本科课程《数值分析》，团队成员：周永涛、高峰
...
1. 2025.07-2026.07
   ...
   <!-- 油气运移的分数阶导数建模与无网格数值求解研究，-->
   工程建模与科学计算湖北省重点实验室开放基金（OF-EMSCHBKL-2025-02），主持

1. 2025.01-2027.12

   <!-- 黄河中下游沉积物中重金属反常扩散建模及仿真研究，-->
   山东省高等学校青年创新团队项目-科学计算与工程应用创新团队，团队成员：周永涛、徐伟、陈虎、张晓钰、王勇、蔡雨婷、于浩

1. 2025.01-2027.12

   <!-- 几类时间分数阶微分方程的高效数值算法研究，-->
   山东省自然科学基金青年项目（ZR2024QA173），主持

1. 2022.01-2024.12

   <!-- 带弱奇异核的Volterra积分和积分-微分方程的块边值方法研究，-->
   国家自然科学基金青年项目（12101037），主持

1. 2022.01-2025.12

   <!-- 分数阶导数问题⍺-鲁棒性数值方法构造与分析，-->
   国家自然科学基金面上项目（12171025），第一参与人

1. 2021.06-2023.03

   <!-- 带弱奇异核Volterra型方程的分层网格块边值方法，-->
   中国博士后科学基金第69批面上资助二等（2021M690322），主持

## 参加会议 

1. 2026年3月27日-3月29日

   第10届分数阶偏微分方程及前沿科学计算方法研讨会，青岛，中国海洋大学
...
1. 2025年7月10日-7月13日
   ...
   中国仿真学会仿真算法专业委员会第九届委员代表大会暨仿真算法学术交流会，上海，上海师范大学
...
1. 周永涛, 黄珊, 耿研霏, 郭宗灿, 苏欣欣, 徐伟, 一种作物产量最大化的生产方式确定方法及系统, ZL202510818253.8, 2025.10.03

1. 徐伟, 刘慧, 周永涛, 张华伟, 赵世军, 缪玉松, 锂电池充放电过程锂离子扩散系数预测方法及系统, ZL202510404064.6, 2025.06.24

1. 徐伟, 刘慧, 张华伟, 赵世军, 周永涛, 李明珠, 预测铜离子在铜铝固-液界面特快扩散的方法及系统, ZL202510404061.2, 2025.06.24

1. 陈丽娟, 李明珠, 白著华, 张森, 李洋, 周永涛, 宋慧, 一种机场出租车载客分配方法及系统, ZL202510628144.X, 2025.08.29

## 软件著作

1. 周永涛，Caputo-Fabrizio导数对流扩散方程数值解法计算软件 V1.0，2025SR2360615，2025.12.05

## 学术论文 
(* 表示通讯作者)
1. Huiru Wang, Xiujun Cheng, Cui Li, Yongtao Zhou*. Block boundary value methods for nonlinear delay singular IVPs. Applied Numerical Mathematics, 229 (2026) 107–119. [paper](https://www.sciencedirect.com/science/article/pii/S0168927426001297?dgcid=author)
